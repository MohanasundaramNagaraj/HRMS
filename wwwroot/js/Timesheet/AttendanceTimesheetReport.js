...
function getData() {
    ...
    var frm = $("<form hidden action='/TimeSheets/AttendanceTimeSheetSummary' method='get'> </form>");
...
function exportExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'AttendanceTimesheetReport');

    XLSX.writeFile(wb, 'AttendanceTimesheetReport.xlsx');
}
