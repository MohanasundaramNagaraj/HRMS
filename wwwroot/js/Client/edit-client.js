document.addEventListener('DOMContentLoaded', async function () {
	...
	let existValue = $('#client_country_phone_code').attr('exist-value');

	if (existValue != '' && existValue != undefined && existValue != null) {
		
		setTimeout(function () {
			$('#client_country_phone_code').val(existValue).trigger('change');
		}, 2000);
	}
});
...
document.getElementById('client-edit-form').addEventListener('submit', function (event) {
