...
namespace SparkHRMS.Migrations
{
    ...
    [Migration("20260617125538_DHK17JUN2026-01_PassportExpiryDate")]
    partial class DHK17JUN202601_PassportExpiryDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SparkHRMS.Data.Entities.Address", b =>
                {
                    ...
                    b.Property<bool>("IsPermanentAddress")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SparkHRMS.Data.Entities.DocAttachments", b =>
                {
            ...
            modelBuilder.Entity("SparkHRMS.Data.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("EmergencyAlternateNumber")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("SparkHRMS.Data.Entities.LeaveRequestHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SparkHRMS.Data.Entities.State", b =>
                {
                    b.Property<int>("StateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SparkHRMS.Data.Setting.SET_NumberConfig", b =>
                {
            ...
            modelBuilder.Entity("SparkHRMS.Data.Entities.LeaveRequestHistory", b =>
                {
                    b.HasOne("SparkHRMS.Data.Entities.LeaveRequest", "LeaveRequest")
                        .WithMany()
                        .HasForeignKey("LeaveRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
